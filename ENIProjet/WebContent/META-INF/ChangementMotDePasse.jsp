...
<body>
	...
	<div class="container">
		...
		<div class="col-lg-6 sm-10 md-12 mb-12">
			<div class="card">
				<div class="card-body">
					<form action="${pageContext.request.contextPath}/MotDePasseChange"
						method="post">
						...
						<label for="nouveaumotdepasse">Veuillez choisir un nouveau
							mot de passe</label> <input class="form-control mr-sm-2" type="password"
							id="nouveaumotdepasse" name="nouveaumotdepasse"
							placeholder="nouveau mot de passe" required><br> <label
							for="confirmationmotdepasse">Veuillez confirmer votre
							nouveau mot de passe</label> <input class="form-control mr-sm-2"
							type="password" id="confirmationmotdepasse"
							name="confirmationmotdepasse"
							placeholder="confirmer mot de passe" required><br>

						<button type="submit" class="btn btn-primary mb-2">Changer
